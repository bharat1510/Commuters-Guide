...
try{
		...
		String sql1="select s.bus_no, s.bus_name, s.type, r.s_station_name, r.d_station_name, s.mon, s.tue, s.wed, s.thu, s.fri, s.sat, s.sun from bus_info s, route_main1 r where s.s_station_id=r.s_station_id and s.bus_no=?;";
...
try{
		...
		String sql2= "select s.station_id, r.station_name, s.arv_time, s.dep_time, r.km from bus_schedule s, route1 r where s.bus_no=? and s.station_id=r.station_id";
		...
		out.println("<h3> Schedule Of The Bus </h3>");
