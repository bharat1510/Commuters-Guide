<html>
<head><title> Welcome to Commuters Guide</title>
	...
	<div class="wrapper">
        <header><br>
            <nav>
				...
				<ul>
					...
					<li><a href="https://www.facebook.com" target="_blank"><button class="btn btn-success btn-md">Like</button></a></li>
				</ul>
                </div>
            </nav>
			...
			<div class="container">
				<div class="no-results">
					<div class="vertical-align">
						<p>The time consuming process of finding the best way for you(by train/bus/other) is reduced with the website which provides details 
				about all the trains, buses, private vehicals.</p>
						<p>Here you can choose your best way,</p>
						<p>with the help of</p>
						<a href="index1.jsp"><button class="btn btn-primary">Train</button></a>&emsp;
						<a href="busbooking/bindex1.jsp"><button class="btn btn-primary">Bus</button></a>&emsp;
						<a href="event/eindex1.jsp"><button class="btn btn-primary">Event</button></a>
					</div>
				</div>
			</div>
			...
			<div class="row">
				...
				<aside class="col-md-4">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<img src="images/p5.png" alt="Digital India" width="360px" height="300px" class="img-results"/>
						</div>
					</div>
				</aside>
				...
				<aside class="col-md-4">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<img src="images/p2.png" alt="smart city" width="360px" height="300px" class="img-results"/>
						</div>
					</div>
				</aside>	
				...
				<aside class="col-md-4">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<img src="images/p6.jpg" alt="Bullet Train" width="360px" height="300px" class="img-results"/>
						</div>
					</div>
				</aside>
		...
		<footer class="footer-distributed">
			...
			<div class="footer-left">
				...
				<h3>Commuters<span>Guide</span></h3>
				...
				<p class="footer-company-name">CommutersGuide &copy; 2019</p>
