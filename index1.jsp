...
<div id="templatemo_wrapper">
	...
	<div id="templatemo_header">
		...
		<div id="site_title">
            <h1><a href="home.jsp">
                <img src="./images/trainicon.jpg" alt="Commuters Guide" width="480" height="93" />
    ...
    <div id="templatemo_content">
    	...
    	<div id="templatemo_slider">
					<embed style="background-color: black;" src="./images/train.mp4" width="605" height="315">
    ...
    <div id="templatemo_sidebar">
		...
		%>
            ...
            <input type="submit" value="SignIn" class="btn btn-info" id="signin" /><br /><br /> <br>
			...
			String sessionid = (String)session.getId();
				...
				<%
					...
					%>
			            ...
			            <label>Password</label>
			            <input type="password" id="password" class="form-control" name="pass" size="6" maxlength="6" class="quote_input" title="Password" />
			            <input type="submit" class="demo" class="btn btn-info" value="SignIn" id="signin" /><br /><br /> <br>
				        <h4> <a href="./UserReg.jsp"> User Registration</a>
				        <br/><br/>
			             <a href="./password.jsp"> Forget Password?</a></h4>
			            </form>
